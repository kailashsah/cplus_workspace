...
void run_const_4() {
	...
	const int* b1 = &a1;
	//1.
	//char* c1 = const_cast <char*> (b1); // compiler error 'const_cast': cannot convert from 'const int *' to 'char *'	.. also stati_cast<> doesn't  .. const_cast<> is strong typecasting ie, between similar types
